...
class Container:
    def __init__(self):
        # base_dir = runtime/leftman_skill_system (contains policies/, prompts/)
        base_dir = Path(__file__).resolve().parents[1]
        # skill_package_root = memorial-skill-builder/ (top-level skill dir)
        skill_package_root = base_dir.parent.parent
        # data_dir for JSON persistence (inside skill package)
        data_dir = skill_package_root / "data" / "runtime"
